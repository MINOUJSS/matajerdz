...
class CreateCompanyLivereursTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('company_livereurs', function (Blueprint $table) {
            ...
            $table->text('livereur_with_id_card_photo')->nullable();
    ...
    {
        Schema::dropIfExists('company_livereurs');
    }
}
