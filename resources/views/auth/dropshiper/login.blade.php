        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center" style="background:url({{asset('admins/'.$template)}}/assets/images/big/auth-bg.jpg) no-repeat center center;">
            <div class="auth-box">
                <div id="">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form class="form-horizontal m-t-20" id="loginform1" action="{{route('dropshiper.login.submit')}}"method="POST" >            
                                @csrf
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <a href="{{route('dropshiper.password.request')}}" id="to-recover" class="text-dark float-right"><i class="fa fa-lock m-r-5"></i> نسيت كلمة المرور ؟</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group m-b-0 m-t-10">
                                    <div class="col-sm-12 text-center">
                                        ليس لدي حساب <a href="{{route('dropshiper.register')}}" class="text-info m-l-5"><b>تسجيل</b></a>
                                    </div>
                                </div>
                            </form>
                        </div>
