        ...
        <div class="auth-box on-sidebar">
            <div>
                <div class="logo">
                    ...
                    <h5 class="font-medium m-b-20">تسجيل حساب شاحن محلي </h5>
                </div>
                <!-- Form -->
                <div class="row">
                    <div class="col-12">
                        <form method="POST" class="form-horizontal m-t-20" action="{{ route('local-livereur.register') }}">
                            @csrf
                            ...
                            <div class="form-group m-b-0 m-t-10 ">
                                <div class="col-sm-12 text-center ">
                                    هل تملك حساب على الموقع? <a href="{{route('local-livereur.login')}}" class="text-info m-l-5 "><b>تسجيل الدخول</b></a>
                                </div>
                            </div>
                        </form>
                    </div>
