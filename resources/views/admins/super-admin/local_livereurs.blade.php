...
{{-- @section('content')
   @include('admins.super-admin.components.local_livereurs.tables.model1')
@endsection --}}
@section('content')
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <input class="form-control mb-2 " type="text" name="search_string" id="search_local_livereur" placeholder="إبحث عن الشاحن">
                    </div>                    
                </div>
                <div id="table-data" class="row">
                @include('admins.super-admin.components.local-livereurs.tables.model1')
                </div>
...
{{-- <script src="{{asset('admins/'.$template)}}/assets/js/local_livereur.js"></script> --}}
...
@include('admins.super-admin.components.local-livereurs.tables.local_livereurs_js')
