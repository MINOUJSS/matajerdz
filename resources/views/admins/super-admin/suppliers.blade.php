...
{{-- @section('content')
   @include('admins.super-admin.components.suppliers.tables.model1')
@endsection --}}
@section('content')
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <input class="form-control mb-2 " type="text" name="search_string" id="search_supplier" placeholder="إبحث عن المورد">
                    </div>                    
                </div>
...
{{-- <script src="{{asset('admins/'.$template)}}/assets/js/supplier.js"></script> --}}
...
@include('admins.super-admin.components.suppliers.tables.suppliers_js')
