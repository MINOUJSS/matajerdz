...
{{-- @section('content')
   @include('admins.super-admin.components.sellers.tables.model1')
@endsection --}}
@section('content')
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <input class="form-control mb-2 " type="text" name="search_string" id="search_seller" placeholder="إبحث عن البائع">
                    </div>                    
                </div>
...
{{-- <script src="{{asset('admins/'.$template)}}/assets/js/seller.js"></script> --}}
...
@include('admins.super-admin.components.sellers.tables.sellers_js')
