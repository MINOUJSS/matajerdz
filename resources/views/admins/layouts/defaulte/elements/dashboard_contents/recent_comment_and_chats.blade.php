                        ...
                        <div class="card">
                            ...
                            <div class="comment-widgets scrollable" style="height:430px;">
                                ...
                                <div class="d-flex flex-row comment-row m-t-0">
                                    <div class="p-2">        
                                        <img src="{{asset('admins/'.$template)}}/assets/images/users/1.jpg" alt="user" width="50" class="rounded-circle">
                                    </div>
                                ...
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2">
                                        <img src="{{asset('admins/'.$template)}}/assets/images/users/4.jpg" alt="user" width="50" class="rounded-circle">
                                    </div>
                                ...
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2">
                                        <img src="{{asset('admins/'.$template)}}/assets/images/users/5.jpg" alt="user" width="50" class="rounded-circle">
                                    </div>
                                    <div class="comment-text w-100">
                                ...
                                <div class="d-flex flex-row comment-row m-t-0">
                                    <div class="p-2">
                                        <img src="{{asset('admins/'.$template)}}/assets/images/users/2.jpg" alt="user" width="50" class="rounded-circle">
                                    </div>
                                    <div class="comment-text w-100">
